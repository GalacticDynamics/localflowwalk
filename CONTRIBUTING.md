...
So you are interested in contributing to `knnp`? Excellent! We love
contributions! `knnp` is open source, built on open source, and we'd love to
have you hang out in our community.

## How to Contribute, Best Practices

Most contributions to `knnp` are done via
[pull requests](https://help.github.com/en/github/collaborating-with-issues-and-pull-requests/about-pull-requests)
from GitHub users' forks of the
[`knnp` repository](https://github.com/GalacticDynamics/nearest-neighbours-with-momentum).
...
- **Performance improvements**: if you are making changes that impact `knnp`
  performance, consider adding a performance benchmark in `tests`.
...
`knnp` maintainer will collaborate with you to make sure that the pull request
meets the requirements for inclusion in the package:

**Relevance:**

- Is the submission relevant to `knnp`?
